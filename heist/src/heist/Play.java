...
abstract class Play extends BasicGameState{
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
		...
		if(this.getID() == 1) {
			g.drawString("Collect all of the Money and Gems on the map, then escape back", 180, 180);
			g.drawString("through the starting point. Beware of the guards! They'll chase", 180, 210);
			g.drawString("you if they see you, or once you grab the gem. Happy Heisting!", 180, 240);
		}
	}
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
		...
		ResourceManager.loadImage("Money.png");
		ResourceManager.loadImage("diamond.png");
	...
	public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
		...
		if(map.tiles[mapY][mapX].tileType == 2) {
			...
			map.tiles[mapY][mapX].removeImage(ResourceManager.getImage("Money.png"));
			map.tiles[mapY][mapX].addImage(ResourceManager.getImage("white.png"));
			yellow++;
		}
		
		if(map.tiles[mapY][mapX].tileType == 3) {
			map.tiles[mapY][mapX].tileType = 0;
			map.tiles[mapY][mapX].removeImage(ResourceManager.getImage("diamond.png"));
			map.tiles[mapY][mapX].addImage(ResourceManager.getImage("white.png"));
			blue++;
			playerFound();	
		}
		...
		if(posX%40 == 0 && posY%40 == 0) {
			...
			if(input.isKeyDown(Input.KEY_W) && !input.isKeyDown(Input.KEY_S)) player.move(0);
				...
				System.out.println("A, Y = "+posY%40);
				...
				System.out.println("D, Y = "+posY%40);
			...
			if(input.isKeyDown(Input.KEY_A) && !input.isKeyDown(Input.KEY_D)) player.move(3);
				...
				System.out.println("W, X = "+posX%40);
				...
				System.out.println("S, X = "+posX%40);
